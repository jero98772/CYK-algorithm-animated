...
For every test case, the program will generate an animation in the **animation/** folder. Each animation will be saved as an `.htm` file and can be opened in any web browser. The animation visually demonstrates how the CYK algorithm fills the table, step by step, for that specific test case.

You can view the animation for each test case by opening the corresponding `.htm` file in a browser.
